...
df
df.to_csv("data.csv") #save as csv
df=pd.read_csv("data.csv",index_col=0) #read csv file
df.to_excel("data.xlsx") #turn to excel
df=pd.read_excel("data.xlsx",index_col=0) #read excl file
...
s = df.to_csv() #string
print(s)
#the continent that corresponds to Russia
df.loc["RUS","CONT"]
